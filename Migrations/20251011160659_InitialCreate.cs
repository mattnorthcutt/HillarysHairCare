    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "jamie@example.com", "Jamie", "Lane", "555-0001" },
                    { 2, "riley@example.com", "Riley", "Park", "555-0002" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Haircut", 35.00m },
                    { 2, true, "Color", 65.00m },
                    { 3, true, "Beard Trim", 15.00m }
                });
            ...
            migrationBuilder.InsertData(
                table: "Appointments",
                columns: new[] { "Id", "CustomerId", "IsCanceled", "Notes", "StartTime", "StylistId" },
                values: new object[] { 1, 1, false, null, new DateTime(2025, 10, 20, 10, 0, 0, 0, DateTimeKind.Unspecified), 1 });
